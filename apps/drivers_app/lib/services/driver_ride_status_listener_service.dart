...
/// Serviço que monitora mudanças de status da corrida ativa do motorista
class DriverRideStatusListenerService {
  ...
  /// Começar a escutar mudanças de status da corrida ativa
  ...
  /// Começar a escutar todas as corridas ativas do motorista
  void startListeningToDriverRides(String driverId) {
    _firestore
        .collection('rides')
      ...
      if (kDebugMode) print('Erro ao escutar corridas do motorista: $error');
    });
  }
  ...
  /// Parar de escutar
  void stopListening() {
    if (kDebugMode) print('Parou de escutar mudanças de status da corrida');
  }
}
